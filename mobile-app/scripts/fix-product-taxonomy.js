...
/*
 * מיפוי מילת מפתח בעברית לקטגוריית טקסונומיה, מהמפורש לכללי.
 *
 * המזהים אינם מומצאים: רובם נלקחו מהקטגוריות שהחנות עצמה כבר משתמשת בהן
 * נכון — 21 מוצרים ב-Floor Cleaning Products, 11 ב-Toilet Bowl Cleaners —
 * והשאר נשלפו בשאילתת טקסונומיה ממוקדת. הסדר הוא ההכרעה: "אקונומיקה"
 * חייבת להיבדק לפני "מנקה", ו"מדיח" לפני "כלים".
 */
const RULES = [
