...
const SOURCES = [
  ...
  /*
   * ניסני חשמל — הסריקה שרצה 28 שעות דרך החסימה וסיימה ב-6.8.2026. 2,773
   * רשומות, כולן עם מחיר, 1,041 מהן עם מקט. §26.23 הניחה שהתוצאה תהיה
   * חסרת ערך על סמך היחס של אספקה (80 מתוך 2,943, אפס מחירים) — ההנחה
   * הזאת הייתה שגויה, וזה המקור המחירי החדש הראשון מאז שהחסימה נסגרה.
   */
  'nisani-catalogue.json',
];
